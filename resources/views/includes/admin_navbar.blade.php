    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item {{ Request::segment(1) === 'dashboard' ? 'active' : null }}">
                <a class="nav-link" href="{{ route('dashboard') }}">Abrigados</a>
            </li>
            <li class="nav-item dropdown {{ Request::segment(1) === 'professionals' ? 'active' : 
                (Request::segment(1) === 'symptoms' ? 'active' : null) }}">
